...
def get_comparison_csv(mode):
    if mode is 'points':
        vanilla_dataframe = read_it_points_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/vanilla_sam_eval'), 'vanilla_sam')
        pannuke_dataframe = read_it_points_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/pannuke_sam_eval'), 'pannuke_sam')
        ...
        vanilla_dataframe = read_it_boxes_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/vanilla_sam_eval'), 'vanilla_sam')
        pannuke_dataframe = read_it_boxes_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/pannuke_sam_eval'), 'pannuke_sam')
        combined_df = pd.concat([vanilla_dataframe, pannuke_dataframe], axis=1)
        combined_df.to_csv('~/comb/combined_data_boxes.csv', index=False)
        return
    else:
        vanilla_dataframe = read_amg_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/vanilla_sam_eval'), 'vanilla_sam')
        pannuke_dataframe_amg = read_amg_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/pannuke_sam_eval'), 'pannuke_sam')
        pannuke_dataframe_instance = read_instance_csv(os.path.join(f'/mnt/lustre-grete/usr/u12649/scratch/models/pannuke_sam_eval'), 'pannuke_sam')
